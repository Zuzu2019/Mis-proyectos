...
import Cards from "../../components/component_categorias/Card_categorias"
...
const Categoria = () => {
    ...
    const ref = doc(db, `/Categorias/${params.id}`)
    const getproduct = query(collection(db, `Productos`), where("categoriaId", "==", ref))
    ...
    useEffect(() => {
        ...
        const getCategorias = async() => {        
            const subcategoriasRef = collection(db, `Categorias/${params.id}/subcategoria1`)
